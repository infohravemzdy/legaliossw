...
func exportPropsIntLine<B : ProviderFactory<P, ProviderSalary>, P : IPropsSalary>(protokol: FileHandle, testYear: Int16, sut: B, function: (P) -> Int32) {
...
func exportPropsDecLine<B : ProviderFactory<P, ProviderSalary>, P : IPropsSalary>(protokol: FileHandle, testYear: Int16, sut: B, function: (P) -> Decimal) {
    exportPropsYear(protokol: protokol, value: testYear)
...
func exportPropsIntFile<B : ProviderFactory<P, ProviderSalary>, P : IPropsSalary>(fileName : String, minYear: Int16, maxYear: Int16, sut: B, function: (P) -> Int32) {
...
func exportPropsDecFile<B : ProviderFactory<P, ProviderSalary>, P : IPropsSalary>(fileName : String, minYear: Int16, maxYear: Int16, sut: B, function: (P) -> Decimal) {
    #if __PROTOKOL_TEST_FILE__
    do {
        let testProtokol = try createProtokolFile(fileName: fileName)
