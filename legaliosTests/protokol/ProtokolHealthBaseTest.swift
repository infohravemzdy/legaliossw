...
func exportPropsIntLine<B : ProviderFactory<P, ProviderHealth>, P : IPropsHealth>(protokol: FileHandle, testYear: Int16, sut: B, function: (P) -> Int32) {
...
func exportPropsDecLine<B : ProviderFactory<P, ProviderHealth>, P : IPropsHealth>(protokol: FileHandle, testYear: Int16, sut: B, function: (P) -> Decimal) {
    exportPropsYear(protokol: protokol, value: testYear)
...
func exportPropsIntFile<B : ProviderFactory<P, ProviderHealth>, P : IPropsHealth>(fileName : String, minYear: Int16, maxYear: Int16, sut: B, function: (P) -> Int32) {
...
func exportPropsDecFile<B : ProviderFactory<P, ProviderHealth>, P : IPropsHealth>(fileName : String, minYear: Int16, maxYear: Int16, sut: B, function: (P) -> Decimal) {
    #if __PROTOKOL_TEST_FILE__
    do {
        let testProtokol = try createProtokolFile(fileName: fileName)
