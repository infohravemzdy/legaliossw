...
class Service_Legalios_Example_03_Social_07_MarginIncomeEmpTest: QuickSpec {
    override func spec() {
        ...
        logTestIntExamples(fileName: "03_Social_07_MarginIncomeEmp.txt", tx: test_examples)
#endif
