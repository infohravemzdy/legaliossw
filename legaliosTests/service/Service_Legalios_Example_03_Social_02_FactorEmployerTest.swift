...
class Service_Legalios_Example_03_Social_02_FactorEmployerTest: QuickSpec {
    override func spec() {
        let test_examples: [(title: String, tests: [(title: String, year: Int16, month: Int16, expYear: Int16, expMonth: Int16, expected: Double)])] = [
            ("2010", [
                ( "2010-1", 2010, 1, 2010, 1, 25.00 ),
                ( "2010-2", 2010, 2, 2010, 2, 25.00 ),
                ( "2010-3", 2010, 3, 2010, 3, 25.00 ),
                ( "2010-4", 2010, 4, 2010, 4, 25.00 ),
                ( "2010-5", 2010, 5, 2010, 5, 25.00 ),
                ( "2010-6", 2010, 6, 2010, 6, 25.00 ),
                ( "2010-7", 2010, 7, 2010, 7, 25.00 ),
                ( "2010-8", 2010, 8, 2010, 8, 25.00 ),
                ( "2010-9", 2010, 9, 2010, 9, 25.00 ),
                ( "2010-10", 2010, 10, 2010, 10, 25.00 ),
                ( "2010-11", 2010, 11, 2010, 11, 25.00 ),
                ( "2010-12", 2010, 12, 2010, 12, 25.00 ),
            ]),
            ("2011", [
