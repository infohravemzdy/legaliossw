...
class Service_Legalios_Example_04_Taxing_10_FactorWithholdTest: QuickSpec {
    override func spec() {
        ...
        logTestDecExamples(fileName: "04_Taxing_10_FactorWithhold.txt", tx: test_examples)
#endif
                ...
                tests.forEach { (title: String, year: Int16, month: Int16, expYear: Int16, expMonth: Int16, expected: Double) in
                    context("period \(title)") {
                        ...
                        it("GetProps should return value = \(expected)") {
                            ...
                            expect(props?.factorWithhold).to(equal(expDecimal))
                        }
                    }
                }
            }
