...
class Service_Legalios_Example_02_Salary_03_MinMonthlyWageTest: QuickSpec {
    override func spec() {
        ...
        logTestIntExamples(fileName: "02_Salary_03_MinMonthlyWage.txt", tx: test_examples)
#endif
                ...
                tests.forEach { (title: String, year: Int16, month: Int16, expYear: Int16, expMonth: Int16, expected: Int32) in
                    context("period \(title)") {
                        ...
                        it("GetProps should return value = \(expected)") {
                            expect(props?.minMonthlyWage).to(equal(expected))
                        }
                    }
                }
            }
