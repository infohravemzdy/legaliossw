...
class Service_Legalios_Example_04_Taxing_20_MarginIncomeOfWthEmpTest: QuickSpec {
    override func spec() {
        ...
        logTestIntExamples(fileName: "04_Taxing_20_MarginIncomeOfWthEmp.txt", tx: test_examples)
#endif
                ...
                tests.forEach { (title: String, year: Int16, month: Int16, expYear: Int16, expMonth: Int16, expected: Int32) in
                    context("period \(title)") {
                        ...
                        it("GetProps should return value = \(expected)") {
                            expect(props?.marginIncomeOfWthEmp).to(equal(expected))
                        }
                    }
                }
            }
