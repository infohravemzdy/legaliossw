...
class Service_Legalios_Example_01_Health_01_MinMonthlyBasisTest: QuickSpec {
    override func spec() {
        ...
        logTestIntExamples(fileName: "01_Health_01_MinMonthlyBasis.txt", tx: test_examples)
#endif
                ...
                tests.forEach { (title: String, year: Int16, month: Int16, expYear: Int16, expMonth: Int16, expected: Int32) in
                    context("period \(title)") {
                        ...
                        it("GetProps should return value = \(expected)") {
                            expect(props?.minMonthlyBasis).to(equal(expected))
                        }
                    }
                }
            }
